...
class mainWindowUI (QMainWindow):
    ...
    def __init__(self):
        ...
        ## set window size
        self.setWindowTitle("TexToMtlX Version 1.3")
    ...
    def retriveMtlName(self, path):
        ...
        for texture in textures:
            ...
            findName = texture.rfind('_')
            mtlName = texture[:findName]
            #texParts = texture.split('_')
            #mtlName = texParts[0]
            mtlRest = texture[findName:] ## new var to avoid materials that have keys in the name, like metalRims has metal in it and can cause issues
    ...
    def myfunc(self):
            ...
            for textureKey, textureValue in textureTypesSorted.items():
                if texture in textureValue:
                    ...
                    if textureKey == 'texturesSSS':
                        ...
                        mtlxStandS.parm('subsurface').set(0.05)
        ...
        if bumpFound or normalFound:
            ...
            if bumpFound and normalFound:
                ...
                mtlxNormal.parm('scale').set(0.01)
